...
/**
* Plugin Name: LinkMyDeals - PremiumPress Upload
* Plugin URI: https://linkmydeals.com/wordpress/#premiumpress
* Description: LinkMyDeals.com provides Coupon & Deal Feeds from 4000+ Online Stores. You can use this plugin to automate/upload the feeds into your PremiumPress Coupon Theme Installation.
* Version: 2.7.2
